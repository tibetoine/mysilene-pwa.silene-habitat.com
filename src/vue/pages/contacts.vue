<template>
  <div style="margin-top:60px;">
    <v-tabs slot="extension" centered color="transparent" slider-color="blue">
      <v-tab key="tab1">
        Personnes
      </v-tab>
      <v-tab key="tab2">
                  ...
                  >
                    <template v-for="contact in visibleContacts">
                      ...
                      >
                        ...
                        <v-list-tile-content>
                          <v-list-tile-title
                            v-html="contact.sn + ' ' + contact.givenName"
                          ></v-list-tile-title>
                        ...
                        <v-list-tile-action>
                          <v-btn icon ripple>
                            <v-icon
                              ...
                              @click.stop="sharingContact(contact)"
                              >share</v-icon
                            >
                          </v-btn>
                        </v-list-tile-action>
                          ...
                          <v-list-tile-action>
                            <v-btn icon ripple>
                              <v-icon
                                ...
                                @click.prevent="sharingContact(contact)"
                                >share</v-icon
                              >
                            </v-btn>
                          </v-list-tile-action>

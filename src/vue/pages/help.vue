    ...
    <v-layout row>
      <v-flex xs12 sm6 offset-sm3>
        <v-toolbar>
          ...
          <v-toolbar-title>Les aides possibles</v-toolbar-title>
        </v-toolbar>
        <v-list two-line>
          <template v-for="(item, index) in items">
            ...
            <v-list-tile v-else :key="item.title">
              ...
              <v-list-tile-content>
               ...
               <v-list-tile-action style="cursor:pointer;"  v-on:click.stop="sendMail(item.email)">
                  <v-icon color="blue">email</v-icon>
                </v-list-tile-action>
                <v-list-tile-action style="cursor:pointer;"  v-on:click.stop="callBryan(item.tel)">

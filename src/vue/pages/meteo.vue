            ...
            <v-flex xs12 id="dayMeteo">
              <v-layout row wrap>
                <v-flex xs12 sm6 style="padding-left:10px;">
                  ...
                  <div class="meteoDate">
                    {{ date(weather.currently.time * 1000) }}
                  </div>
                  <div class="meteoSummary">
                  ...
                  <v-layout row wrap class="meteoCara">
                    <v-flex xs6>
                      <v-layout row wrap class="meteoCara2">
                        ...
                        <v-flex xs5>
                          <strong
                            >{{
                              toPercentage(weather.currently.precipProbability)
                            }}%</strong
                          >
                        </v-flex>
                      </v-layout>
                      <v-layout row wrap class="meteoCara2">
                        ...
                        <v-flex xs5>
                          <strong
                            >{{
                              toPercentage(weather.currently.cloudCover)
                            }}%</strong
                          >
                        </v-flex>
                      </v-layout>
                      <v-layout row wrap class="meteoCara2">
                        ...
                        <v-flex xs5>
                          <strong
                            >{{
                              toPercentage(weather.currently.humidity)
                            }}%</strong
                          >
                        </v-flex>
                      </v-layout>
                    ...
                    <v-flex xs6>
                      <v-layout row wrap class="meteoCara2">
                        ...
                        <v-flex xs5>
                          <strong
                            >{{ weather.currently.windSpeed }} km/h</strong
                          >
                        </v-flex>
                      </v-layout>
                      <v-layout row wrap class="meteoCara2">
                        ...
                        <v-flex xs5>
                          <strong>{{
                            timestamp(weather.daily.data[0].sunriseTime * 1000)
                          }}</strong>
                        </v-flex>
                      </v-layout>
                      <v-layout row wrap class="meteoCara2">
                        ...
                        <v-flex xs5>
                          <strong>{{
                            timestamp(weather.daily.data[0].sunsetTime * 1000)
                          }}</strong>
                        </v-flex>
                      </v-layout>
                    </v-flex>
